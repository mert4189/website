...
const GecmisTalep = () => {
    ...
    useEffect(() => {
        const cekData = async () => {
            try {
                const ad = getAd.ad !== undefined ? getAd.ad : getAd;
                const response = await axios.get(`http://localhost:8080/altalep?getAd=${ad}`);
                ...
                <Navbar bg="light" variant="light" expand="md">
                    <Container>
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                            ...
                            <Nav>
                                <NavLink exact activeClassName="active" to="/Customer  v " className="nav-link">Anasayfa</NavLink>
