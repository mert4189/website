...
const Adminolustur = () => {
          ...
          try {
            if (getUser.user !== undefined) {
              ...
              setGelenadmin1(response.data);
                ...
                const response = await axios.get(`http://localhost:8080/aladminad/` + getUser);
                setGelenadmin1(response.data);
              // getUser.user undefined ise burada istediğiniz işlemi gerçekleştirin
            }
          } catch (error) {
            console.log(error);
          }
    ...
    const sumbitForm = (e) => {
        ...
        if (!ad || !soyad || !kullanıcıadı || !sifre || !mail || !telno || !rol) {
        ...
        let senddata = {
            ...
            telno:data.telno,
            mail:data.mail,
            olusturankisi:gelenadmin1[0].ad + gelenadmin1[0].soyad
                        ...
                        <div className="container">
                            <form className="row g-3">
                                ...
                                <div style={{ marginTop: "30px", marginLeft: "" }} className="col-md-8">
                                    ...
                                    <input type="text" className="form-control" id="mail" onChange={handleChange} value={data.mail} />
                                </div>
                                <div style={{ marginTop: "30px", marginLeft: "" }} className="col-md-8">
